...
Ce document donne un guide pour installer  \git{}  dans notre environnement comprenant des machines Macintosh. Il est une synthèse de plusieurs prompts faits à chat GPT, des essais et erreur, et de vérification.
Il est  organisé pour donner les commandes nécessaires et pour vérifier que l'installation progresse à chaque étape.
